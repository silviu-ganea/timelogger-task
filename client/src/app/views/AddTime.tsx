        ...
        <div className="grid min-h-screen place-items-center">
            <div className="w-11/12 p-12 bg-white sm:w-8/12 md:w-1/2 lg:w-5/12">
                ...
                <form className="mt-6" onSubmit={formSubmitHandler}>
                    ...
                    <input id="dateAdded" type="text" value={newTimeEntry.dateAdded || ''} onChange={e => setNewTimeEntry({...newTimeEntry, dateAdded: e.target.value })} name="dateAdded" className="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" required />
